...
export function SignUp() {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-gray-50 dark:bg-gray-950 px-4 font-sans transition-colors duration-200">
      <motion.div
      ...
      >
        ...
        <div className="mt-3 text-center text-sm text-gray-500 dark:text-gray-400 transition-colors">
